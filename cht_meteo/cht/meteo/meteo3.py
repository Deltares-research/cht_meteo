...
class MeteoGrid:
    ...
    def write(self, format, file_name, version="1.03", path=None, header_comments=False, refdate=None, parameters=None, time_range=None):
        pass
...
#            fid.write("y_llcorner       =   " + str(min(self.y)) + "\n")
    ...
    def find_cyclone_tracks(self,
        ...
        for it in range(0, nt, tstride):
            ...
            xeye, yeye, vmax, peye = find_cyclone_eyes(x, y, u, v, p, dist, xlim, ylim, method, pcyc, vcyc, vmin)
